...
This code, separated into the groupings: descriptive (and engagement), ability, and motivation, and all the plots, as separate branches can be also found at https://github.com/JSMoom/lucky-13/branches.
